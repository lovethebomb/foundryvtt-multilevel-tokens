...
class MultilevelTokens {
  ...
  _getSceneScaleFactor(scene) {
    ...
    return {
      x: scene.data.gridType === CONST.GTRID_TYPES.HEXODDR || scene.data.gridType === CONST.GRID_TYPES.HEXEVENR ? hexScale : 1,
      y: scene.data.gridType === CONST.GRID_TYPES.HEXODDQ || scene.data.gridType === CONST.GRID_TYPES.HEXEVENQ ? hexScale : 1,
    };
  }
